export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Our preference is to plan, design, and develop business websites from the ground up rather than forcing your goals into a generic template. That means we can shape the site around your services, customers, locations, SEO priorities, content, integrations, and future growth plans from day one.",
  },
] as const
