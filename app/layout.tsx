...
export const metadata: Metadata = {
  ...
  description: "UK web design, development and branding studio building bespoke, high-performance websites for businesses of all scales and public sector organisations.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Bespoke website design, development and branding for businesses of all scales and public sector organisations.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Bespoke Websites for Businesses of All Scales | Devora",
    description: "Bespoke websites and brand identities for businesses of all scales and public sector organisations.",
